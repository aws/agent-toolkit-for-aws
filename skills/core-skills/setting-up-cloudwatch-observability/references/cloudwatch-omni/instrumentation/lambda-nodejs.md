# Instrument a Node.js Lambda Function with ADOT

Add the ADOT Node.js Lambda layer to a function so it emits OpenTelemetry traces, with Application Signals explicitly disabled.

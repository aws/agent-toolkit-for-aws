...
OpenClaw is banned on Amazon assets, so this does not run OpenClaw. Instead it
reproduces the *documented loading mechanics* that determine whether a skill
works there, and checks the agents-pay folder against them:

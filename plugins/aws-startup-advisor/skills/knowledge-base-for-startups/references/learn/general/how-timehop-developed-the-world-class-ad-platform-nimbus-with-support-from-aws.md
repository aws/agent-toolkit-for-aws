---
source_url: https://aws.amazon.com/startups/learn/how-timehop-developed-the-world-class-ad-platform-nimbus-with-support-from-aws
...
The massive success of Nimbus within the ecosphere of Timehop inspired the team to launch Nimbus as a SaaS, mobile ad-auction platform. It meant being able to help other publishers generate higher revenues with the same attention on the quality of the user's experience.

## Increasing growth with AWS Glue

Providing the tools to forecast and support Timehop and Nimbus's infrastructure, AWS played a significant role in the company's foundation. [AWS Glue](https://aws.amazon.com/glue/?whats-new-cards.sort-by=item.additionalFields.postDateTime&whats-new-cards.sort-order=desc) and [Amazon Athena](https://aws.amazon.com/athena/?whats-new-cards.sort-by=item.additionalFields.postDateTime&whats-new-cards.sort-order=desc) are two of the services that were most instrumental in optimizing Nimbus' overall cost and upscaling its value.
...
If you'd like to explore how AWS can help you to scale your business or develop new products, [connect with the AWS startups team](https://pages.awscloud.com/GLOBAL-startup-LN-startups-website-contact-us-2020-reg.html?), and start building today.
